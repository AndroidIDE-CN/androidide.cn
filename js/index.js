...
function showVersionAdminDialog(){
	openFullScreenDialog(
		'管理版本',
		'<div id="admin_version_list_div" class="layout-root mdui-row-xs-1 mdui-row-sm-2 mdui-row-md-3 mdui-row-lg-4 mdui-row-xl-5 mdui-m-a-0"><div class="mdui-col mdui-p-l-2 mdui-p-t-2 mdui-hide"><div class="mdui-card mdui-hoverable"><div class="mdui-card-menu"><button onclick="showVersionEditDialog(\'release\');" class="mdui-btn mdui-btn-icon mdui-btn-dense mdui-text-color-theme-icon"><i class="mdui-icon material-icons">edit</i></button></div><div class="mdui-card-primary mdui-p-t-2 mdui-p-b-0"><div class="mdui-typo-title mdui-valign"><span id="release_version_name">Release VersionName</span><div class="mdui-typo mdui-m-l-1"><p class="mdui-typo-subheading"><kbd class="mdui-color-pink">正式版</kbd></p></div></div><div id="release_version_update_time" class="mdui-card-primary-subtitle">ReleaseVersion UpdateTime</div></div><div id="release_version_update_log" class="mdui-card-content mdui-p-t-1 mdui-p-b-0" style="overflow: hidden;text-overflow: ellipsis;-webkit-line-clamp: 5;display: -webkit-box;-webkit-box-orient: vertical;">ReleaseVersion UpdateLog</div><div class="mdui-card-actions"><button onclick="showVersionEditDialog(\'release\');" class="mdui-btn mdui-color-theme-accent mdui-ripple mdui-float-right" style="display: none;">编辑</button></div></div></div><div class="mdui-col mdui-p-l-2 mdui-p-t-2 mdui-hide"><div class="mdui-card mdui-hoverable"><div class="mdui-card-menu"><button onclick="showVersionEditDialog(\'beta\');" class="mdui-btn mdui-btn-icon mdui-btn-dense mdui-text-color-theme-icon"><i class="mdui-icon material-icons">edit</i></button></div><div class="mdui-card-primary mdui-p-t-2 mdui-p-b-0"><div class="mdui-typo-title mdui-valign"><span id="beta_version_name">Beta VersionName</span><div class="mdui-typo mdui-m-l-1"><p class="mdui-typo-subheading"><kbd class="mdui-color-pink">测试版</kbd></p></div></div><div id="beta_version_update_time" class="mdui-card-primary-subtitle">BetaVersion UpdateTime</div></div><div id="beta_version_update_log" class="mdui-card-content mdui-p-t-1 mdui-p-b-0" style="overflow: hidden;text-overflow: ellipsis;-webkit-line-clamp: 5;display: -webkit-box;-webkit-box-orient: vertical;">BetaVersion UpdateLog</div><div class="mdui-card-actions"><button onclick="showVersionEditDialog(\'beta\');" class="mdui-btn mdui-color-theme-accent mdui-ripple mdui-float-right" style="display: none;">编辑</button></div></div></div></div><form class="mdui-p-x-3" id="admin_update_edit_form"></form>',
		'更新', function(){
